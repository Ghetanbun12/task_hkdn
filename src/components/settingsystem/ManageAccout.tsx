...
const ManageAccout: React.FC<DeviceListProps> = ({ onViewDetail, onEdit, onCreateNew }) => {
  ...
  const listColumns: ColumnsType<DeviceData> = [
    { title: 'Tên đăng nhập', dataIndex: 'code', key: 'code' },
    { title: 'Họ tên', dataIndex: 'name', key: 'name' },
    { title: 'Số điện thoại', dataIndex: 'description', key: 'description' },
    { title: 'Email', dataIndex: 'description', key: 'description' },
    {title: 'Vai trò', dataIndex: 'description', key: 'description'},
    {
      title: 'Trạng thái',
      dataIndex: 'status',
      key: 'status',
