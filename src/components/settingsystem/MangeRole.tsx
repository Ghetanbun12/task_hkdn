...
const ManageRole: React.FC<DeviceListProps> = ({ onViewDetail, onEdit, onCreateNew }) => {
  ...
  const listColumns: ColumnsType<DeviceData> = [
    { title: 'Tên vai trò', dataIndex: 'code', key: 'code' },
    { title: 'Số người dùng', dataIndex: 'name', key: 'name' },
