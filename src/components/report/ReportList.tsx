...
const ReportList: React.FC<DeviceListProps> = ({ onViewDetail, onEdit, onCreateNew }) => {
  ...
  const listColumns: ColumnsType<DeviceData> = [
    { title: 'Số thứ tự', dataIndex: 'code', key: 'code' },
    { title: 'Tên dịch vụ', dataIndex: 'name', key: 'name' },
    {title: 'Thời gian cấp', dataIndex:'',key:''},
    {title: 'tình trạng',dataIndex:'',key:''},
    { title: 'Nguồn cấp', dataIndex: 'description', key: 'description' },
  ];
